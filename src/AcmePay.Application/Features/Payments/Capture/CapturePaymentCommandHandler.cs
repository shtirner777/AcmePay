    ...
    : ICommandHandler<CapturePaymentCommand, CapturePaymentResult>
{
        ...
        CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            var idempotency = await idempotencyStore.TryBeginAsync<CapturePaymentResult>(
                idempotencyRequest,
                cancellationToken);
            ...
            var captureReference = new CaptureReference(($"CAP-{Guid.NewGuid():N}")[..20]);

            payment.Capture(amount, captureReference, now);
            ...
            var result = new CapturePaymentResult(
                ...
                payment.RemainingAuthorizedAmount.Amount,
